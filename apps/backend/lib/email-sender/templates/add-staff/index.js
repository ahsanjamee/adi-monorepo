...
>
                                      ...
                                      <tr>
                                        <td style='width:150px;'>
                                          ...
                                          <img
                                            alt
                                            height='auto'
                                            src='https://res.cloudinary.com/dypzowqgf/image/upload/v1719757314/logo-2_kg5t8w.png'
 ...
 <h2>Hello ${option.name}</h2>
    ...
    option.cname
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">Joy Electronics Team</p></p>
