...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>Joy Electronics</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at admin@joyelectronics.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>Joy Electronics Team</strong>
             `,
    };
