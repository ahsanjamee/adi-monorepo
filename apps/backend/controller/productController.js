...
const updateProduct = async (req, res) => {
  ...
  try {
    ...
    if (product) {
      ...
      product.supports = req.body.supports;
      product.features = req.body.features;
      product.technicalSpecifications = req.body.technicalSpecifications;
        ...
        $or: [
          ...
          },
          {
            $and: [
              { isCombination: false },
              {
                "prices.discount": { $gt: 0, $type: "int" }, // Match only integer discounts
              },
              // {
              //   $expr: {
              //     $gt: [
