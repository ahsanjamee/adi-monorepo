...
const modules = {
  toolbar: [
    ...
    ['link', 'image'],
    ['clean'],
    ['table'] // Native table support in Quill 2.x
  ],
};
...
const ProductDrawer = ({ id }) => {
  ...
  const salePriceWatch = watch('price');

  const getDiscount = useMemo(() => {
    const res = ((Number(originalPriceWatch) - Number(salePriceWatch)) / Number(originalPriceWatch)) * 100;
    return (isNaN(res) || res < 0 || !isFinite(res)) ? 0 : `${res}%`;
  }, [originalPriceWatch, salePriceWatch])
            ...
            <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  <Controller
                    ...
                    render={({ field }) => (
                      <ReactQuill
                        className="border text-sm dark:text-black block w-full bg-gray-100 border-gray-200 rounded-lg"
                        value={field.value}
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  ...
                  />
                  <Error errorName={errors.features} />
                </div>
              </div>

              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label="Technical Specifications" />
                <div className="col-span-8 sm:col-span-4">
                  <Controller
                  ...
                  />
                  <Error errorName={errors.technicalSpecifications} />
                </div>
              </div>

              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label='Support' />
                <div className="col-span-8 sm:col-span-4">
                  <Controller
                    name="supports"
                    control={control}
                  ...
                  />
                  <Error errorName={errors.supports} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={'Discount applied'} />
                <div className="col-span-8 sm:col-span-4">
                  <Input
                    disabled={true}
                    value={getDiscount}
