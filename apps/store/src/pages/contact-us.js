      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          ...
          {loading ? (
              ...
              <div className="bg-[#E9F7E9] border p-10 rounded-lg text-center">
                ...
                <p className="mb-0 text-x1 opacity-90 leading-7">
                  <span>
                    {showingTranslateValue(
            ...
            {loading ? (
              ...
              <div className="bg-[#E9F7E9] border p-10 rounded-lg text-center">
                ...
                <p className="mb-0 text-xl opacity-90 leading-7 font-bold">
                  <a
