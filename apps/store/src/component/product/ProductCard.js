...
import { IoAdd, IoBagAddSharp, IoEye, IoRemove } from "react-icons/io5";
      ...
      <div className="group box-border overflow-hidden flex rounded-md shadow-lg pe-0 flex-col items-center bg-white relative ">
        <div className="w-full flex justify-between">
          ...
          <button
            ...
            aria-label="cart"
            className="h-8 w-9 group-hover:flex absolute right-4 top-6 z-10 hidden items-center justify-center border border-gray-200 rounded text-emerald-500 hover:border-emerald-500 hover:bg-emerald-500 hover:text-white transition-all"
          >
        ...
        <div className="w-full px-3 lg:px-4 pb-4 overflow-hidden">
          <div className="relative mb-1">
            ...
            <h2 className="text-heading truncate mb-0 block text-sm font-bold text-gray-600">
