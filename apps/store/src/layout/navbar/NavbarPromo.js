...
const NavbarPromo = () => {
  ...
  return (
    <>
      <div className="hidden lg:block xl:block bg-emerald-500 border-b text-[#E9F7E9]">
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10 h-12 flex justify-between items-center">
                  ...
                  >
                    {storeCustomizationSetting?.navbar
                      ...
                      <Popover className="relative font-serif">
                        <Popover.Button className="group inline-flex items-center py-2 hover:text-white focus:outline-none">
                          ...
                          <ChevronDownIcon
                            className="ml-1 h-3 w-3 group-hover:text-white "
                            aria-hidden="true"
                          />
                        </Popover.Button>
                        ...
                        >
                          <Popover.Panel className="absolute z-10 -ml-1 mt-1 transform w-screen max-w-xs c-h-65vh bg-white text-black">
                    ...
                    {storeCustomizationSetting?.navbar?.about_menu_status && (
                      <Link
                        ...
                        className="font-serif mx-4 py-2 text-sm font-bold hover:text-white "
                      >
                        {showingTranslateValue(
                    ...
                    {/* <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 text-sm font-bold hover:text-emerald-600 focus:outline-none">
                        <span>
                          {showingTranslateValue(
                                ...
                                <span className="p-2  font-serif items-center rounded-md hover:bg-gray-50 w-full hover:text-emerald-600">
                                  <div className="w-full flex">
                                    ...
                                    <Link
                                      href="/offer"
                                      onClick={() => setIsLoading(!isLoading)}
                                      className="relative inline-flex items-center font-serif ml-2 py-0 rounded text-sm font-bold  hover:text-emerald-600"
                                    >
                                      {showingTranslateValue(
                                        storeCustomizationSetting?.navbar
                                          ?.offers
                    ...
                    {storeCustomizationSetting?.navbar?.offers_menu_status && (
                      <Link
                        href="/offer"
                        onClick={() => setIsLoading(!isLoading)}
                        className="relative inline-flex items-center  bg-red-100 font-serif ml-4 py-0 px-2 rounded text-sm font-bold text-red-500 hover:text-white "
                      >
                        {showingTranslateValue(
          ...
          <div className="flex">
            ...
            {/* Disabling the language switch option */}
